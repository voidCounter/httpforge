    ...
    <div className="bg-white border border-gray-200 p-8 mb-6">
      <div className="mb-6">
        ...
        <p className="font-mono text-xs text-gray-600 leading-relaxed">
          ...
          <span className="font-semibold text-gray-900">53.5%</span> failure rate at c=1000.
          thread-pool maintains <span className="font-semibold text-gray-900">100%</span> success
          across all loads.
        </p>
      </div>
